...
# 冻结图像编码器中的大部分参数，只解冻最后几层
for name, param in model.visual.named_parameters():
    if "resblocks" in name:
        # 只解冻视觉模型中的最后两层
        if "11" in name or "10" in name:  # 解冻倒数第1和第2层的参数
